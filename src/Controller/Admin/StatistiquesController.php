...
class StatistiquesController extends AbstractController
{
    ...
    private function computeStats(): array
    {
        ...
        foreach ($allUsers as $u) {
            ...
            elseif (in_array('ROLE_CONDUCTEUR', $roles)) $conducteurs++;
            else                                          $passagers++;
        }
        ...
        return compact(
            'totalTrajets', 'trajetsTermine', 'trajetsActif', 'trajetsAnnule', 'trajetsEnCours',
            'totalReservations', 'reservationsConfirmee', 'reservationsAnnulee', 'reservationsTerminee',
            'totalArgent',
            'totalUsers', 'usersActif', 'usersSuspendu', 'usersEnAttente', 'conducteurs', 'passagers', 'admins',
            'totalAvis', 'noteMoyenne'
        );
    }
